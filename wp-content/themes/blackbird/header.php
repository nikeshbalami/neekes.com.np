                    ...
                    <div class="header">
                        ...
                        <div class="grid_8 omega">
                            <div class="header-info">
                                ...
                                <?php } else { ?>
                                    <p class="cell"><img src="<?php echo get_template_directory_uri(); ?>/images/call-us.png"  class="call-us" />&nbsp;Call Me: +9771-9813002788</p>
                                <?php } ?>
                                ...
                                <?php } else { ?>
                                    <p><?php _e('Balaju-16, Kathmandu, Nepal','black-bird'); ?></p>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
